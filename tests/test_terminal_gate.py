...
from ariadne import runtime as runtime_package  # noqa: E402
from source_view import code_only  # noqa: E402
from ariadne.runtime import (  # noqa: E402  (path is prepared above)
    CONTINUE,
    FIELD_ORDER,
...
for path in (
    CONTRACTS / "decision-envelope.md",
    RUNTIME / "decision.py",
...
envelope_doc = (CONTRACTS / "decision-envelope.md").read_text(encoding="utf-8")

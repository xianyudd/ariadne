...
from runtime.decision_engine import DECISION_PHASE, decide  # noqa: E402
...
# These four rows are `.agent-sdlc/core/terminal-contract.md`, and were previously
# asserted against `classify_entity.decision_for_entity`. They now run against the
# one engine, which is the only place the mapping exists.
TERMINAL_CONTRACT = (

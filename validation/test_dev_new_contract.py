...
from runtime.lifecycle import NEW  # noqa: E402
...
workflow = (SDLC / "workflows" / "dev-new.md").read_text(encoding="utf-8")
...
merge = (SDLC / "workflows" / "dev-merge.md").read_text(encoding="utf-8")

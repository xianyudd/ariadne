...
def evaluate_workflow(
    ...
    *,
    ...
    parameter through which a caller could inject one. Configuration describes the
    repository being read and is loaded from it when not supplied; it cannot reach
    the decision, which reads only the resolved state.
    """

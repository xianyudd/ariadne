...
A new session must restore from actual Git/source, the tasks file, the Feature's specification artifacts, and the recorded state file. Chat summaries are lowest-priority evidence.
